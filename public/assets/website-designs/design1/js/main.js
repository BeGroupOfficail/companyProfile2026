(function ($) {
  ...
  $(document).ready(function () {
    $('.main-slider-one__item').each(function () {
        const $wrapper = $(this);
        const $carousel = $wrapper.find('.destinations-two__carousel');
        ...
        // Bind nav to this specific carousel
        $wrapper.find('.main-slider-one__carousel__nav--left').on('click', function () {
            $carousel.trigger('prev.owl.carousel');
        });

        $wrapper.find('.main-slider-one__carousel__nav--right').on('click', function () {
            $carousel.trigger('next.owl.carousel');
        });
    });
});
  $(document).ready(function () {
    $('.feature-package--two').each(function () {
        const $wrapper = $(this);
        const $carousel = $wrapper.find('.feature-package__carousel');
        ...
        $carousel.owlCarousel({
            items: 1,
                ...
                // Bind nav to this specific carousel
        $wrapper.find('.feature-package__carousel__nav--left').on('click', function () {
          $carousel.trigger('prev.owl.carousel');
      });

      $wrapper.find('.feature-package__carousel__nav--right').on('click', function () {
          $carousel.trigger('next.owl.carousel');
      });
        });
    ...
    $(document).ready(function () {
      $('.about-testimonials__carousel').owlCarousel({
              items: 1,
              margin: 30,
              loop: false,
              smartSpeed: 700,
    ...
    $(document).ready(function () {
          ...
          // Initialize this specific carousel
          $('.instagram-one__carousel').owlCarousel({
             items: 6,
                margin: 30,
                loop: true,
                smartSpeed: 700,
      ...
      $(document).ready(function () {
        ...
        // Initialize this specific carousel
        $('.destination-carousel__inner').owlCarousel({
           items: 1,
            margin: 30,
            loop: true,
            smartSpeed: 700,
