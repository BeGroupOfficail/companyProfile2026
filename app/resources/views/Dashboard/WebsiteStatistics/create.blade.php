<x-dashboard.layout :title="__('dash.add_websiteStatistic')">

    <!--begin::Form-->
    <form method="post" action="{{route('website-statistics.store')}}" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('website-statistics.index')}}" enctype="multipart/form-data">
        @csrf
        <!--begin::Aside column-->
