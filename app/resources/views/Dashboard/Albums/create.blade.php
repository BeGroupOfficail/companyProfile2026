<x-dashboard.layout :title="__('dash.add_album')">

    <!--begin::Form-->
    <form method="post" action="{{route('albums.store')}}" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('albums.index')}}" enctype="multipart/form-data">
        @csrf
