<x-dashboard.layout :title="__('dash.add_permission')">

    <!--begin::Form-->
    <form method="post" action="{{route('users.permissions.store')}}" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('users.permissions.index')}}" enctype="multipart/form-data">
        @csrf
        <!--begin::Main column-->
