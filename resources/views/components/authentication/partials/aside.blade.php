...
<div class="d-flex flex-lg-row-fluid">
    ...
    <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
        <!--begin::Image-->
        <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="{{ Path::dashboardPath('media/auth/agency.png')}}" alt="Login image" />
        <img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="{{ Path::dashboardPath('media/auth/agency-dark.png')}}" alt="Login image" />
        <!--end::Image-->
