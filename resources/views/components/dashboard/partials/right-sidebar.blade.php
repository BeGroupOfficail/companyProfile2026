                ...
                <form class="form" method="POST" id="kt_app_layout_builder_form" action="#">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="form-group">
                            <!--begin::Heading-->
                            <div class="mb-6">
                                <h4 class="fw-bold text-gray-900">@lang('dash.board mode')</h4>
                                <div class="fw-semibold text-muted fs-7 d-block lh-1">
                                    @lang('dash.Enjoy Dark & Light modes')
                                </div>
                            </div>
                            <!--end::Heading-->
                            ...
                            <div class="row " data-kt-buttons="true" data-kt-buttons-target=".form-check-image,.form-check-input">
                                ...
                                <div class="col-6">
                                    ...
                                    <label class="form-check-image form-check-success">
                                        ...
                                        <div class="form-check-wrapper border-gray-200 border-2">
                                            <img src="assets/media/preview/demos/demo55/light-ltr.png" class="form-check-rounded mw-100" alt="" />
                                        </div>
                                        <!--end::Image-->
                                ...
                                <div class="col-6">
                                    ...
                                    <label class="form-check-image form-check-success">
                                        <!--begin::Image-->
                                        <div class="form-check-wrapper border-gray-200 border-2">
                                            <img src="assets/media/preview/demos/demo55/dark-ltr.png" class="form-check-rounded mw-100" alt="" />
                                        </div>
                                        <!--end::Image-->
...
<button id="kt_app_layout_builder_toggle" class="btn btn-dark app-layout-builder-toggle lh-1 py-4 " title="Metronic Builder" data-bs-custom-class="tooltip-inverse" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">
    <i class="ki-outline ki-setting-4 fs-4 me-1"></i> @lang('dash.Customize')
</button>
