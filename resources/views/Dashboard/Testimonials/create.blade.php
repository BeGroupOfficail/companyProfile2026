<x-dashboard.layout :title="__('dash.add_testimonial')">

    <!--begin::Form-->
    <form method="post" action="{{route('testimonials.store')}}" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('testimonials.index')}}" enctype="multipart/form-data">
        @csrf
        <!--begin::Aside column-->
