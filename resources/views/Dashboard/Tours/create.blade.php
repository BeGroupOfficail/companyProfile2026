<x-dashboard.layout :title="__('dash.add_tour')">

    <!--begin::Form-->
    <form method="post" action="{{route('tours.store')}}" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('tours.index')}}" enctype="multipart/form-data">
        @csrf
        <!--begin::Aside column-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    ...
                                    <x-dashboard.partials.html.input
                                        ...
                                        :value="old('person_price_per_day', '')"
