<x-dashboard.layout :title="__('dash.add_menu')">

    <!--begin::Form-->
    <form method="post" action="{{route('menus.store')}}" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('menus.index')}}" enctype="multipart/form-data">
        @csrf
        <!--begin::Aside column-->
