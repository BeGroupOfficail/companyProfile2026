    ...
    <form method="post" action="{{route('categories.store')}}" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('categories.index')}}" enctype="multipart/form-data">
            ...
            {{-- <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                        ...
                        <option></option>
                        <option value="1">{{ __('dash.yes') }}</option>
                        <option value="0">{{ __('dash.no') }}</option>
                    </select>
                    <!--end::Select2-->

                    <!--begin::Description-->
                    <div class="text-muted fs-7">{{ __('dash.Set the') }} {{ __('dash.field') }} {{ __('dash.job_seeker') }}.
                    </div>
                    <!--end::Description-->
                </div>
                <!--end::Card body-->
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2">
                <!--begin:::Tab item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#tab1">{{ __('dash.add_category') }}</a>
                </li>
                <!--end:::Tab item-->
