<x-dashboard.layout :title="__('dash.edit_permission')">

    <!--begin::Form-->
    <form method="POST" action="{{route('users.permissions.update',$permission->id)}}" class="form d-flex flex-column flex-lg-row">
        @csrf
        @method('PATCH')
