<x-dashboard.layout :title="__('dash.add_section')">

    <!--begin::Form-->
    <form method="post" action="{{route('sections.store')}}" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('sections.index')}}" enctype="multipart/form-data">
        @csrf
        <!--begin::Aside column-->
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="{{ __('dash.Select an option') }}" name="is_active" id="kt_ecommerce_add_product_status_select">
                        <option value="1" selected="selected">{{ __('dash.active') }}</option>
