<x-dashboard.layout :title="__('dash.add_country')">

    <!--begin::Form-->
    <form method="post" action="{{route('settings.countries.store')}}" class="form d-flex flex-column flex-lg-row"
    data-kt-redirect="{{route('settings.countries.store')}}" enctype="multipart/form-data">
        @csrf
        <!--begin::Main column-->
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <div class="d-flex justify-content-end">
                <!--begin::Button-->
                <a href="{{route('settings.countries.index')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">{{__('dash.Cancel')}}</a>
                <!--end::Button-->
