<x-dashboard.layout :title="__('dash.edit_blog_category')">

    <!--begin::Form-->
    <form method="POST" action="{{route('blog-categories.update',$blogCategory->id)}}" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('categories.index')}}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <!--begin::Aside column-->
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
            ...
            <x-dashboard.partials.html.image_input
                ...
                :model="$blogCategory"
                :imageModelName="'blog_categories'"
            />
            <!--end::image -->
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2">
                ...
                <!--begin:::Tab item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#tab2">{{ __('seo info') }}</a>
                </li>
                <!--end:::Tab item-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    @foreach(config('languages') as $lang => $languageName)
                                        <x-dashboard.partials.html.input
                                            ...
                                            :value="old('name_' . $lang, $blogCategory->getTranslation('name', $lang) ?? '')"
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    @foreach(config('languages') as $lang => $languageName)
                                        <x-dashboard.partials.html.textarea
                                            ...
                                            :value="old('short_desc_' . $lang, $blogCategory->getTranslation('short_desc', $lang) ?? '')"
                                ...
                                @foreach(config('languages') as $lang => $languageName)
                                    <x-dashboard.partials.html.textarea_with_editor
                                        ...
                                        :value="old('long_desc_' . $lang, $blogCategory->getTranslation('long_desc', $lang) ?? '')"
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex mt-3">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid me-5">
                                                <input class="form-check-input" type="radio" value="1" name="home" @checked($blogCategory->home == 1) >
                                                <label class="form-check-label" for="home_yes">@lang('dash.yes')</label>
                                            </div>

                                            <div class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio" value="0" name="home" @checked($blogCategory->home == 0)>
                                ...
                                <div class="row fv-row mb-7">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex mt-3">
                                            <!--begin::Radio-->
                                            <div class="form-check form-check-custom form-check-solid me-5">
                                                <input class="form-check-input" type="radio" value="1" name="menu" @checked($blogCategory->menu == 1)>
                                                <label class="form-check-label" for="header_yes">@lang('dash.yes')</label>
                                            </div>

                                            <div class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio" value="0" name="menu" @checked($blogCategory->menu == 0)>
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    @foreach(config('languages') as $lang => $languageName)
                                        <x-dashboard.partials.html.input
                                            ...
                                            :value="old('slug_' . $lang, $blogCategory->getTranslation('slug', $lang) ?? '')"
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    @foreach(config('languages') as $lang => $languageName)
                                        <x-dashboard.partials.html.input
                                            ...
                                            :value="old('meta_title_' . $lang, $blogCategory->getTranslation('meta_title', $lang) ?? '')"
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    @foreach(config('languages') as $lang => $languageName)
                                        <x-dashboard.partials.html.textarea
                                            ...
                                            :value="old('meta_desc_' . $lang, $blogCategory->getTranslation('meta_desc', $lang) ?? '')"
