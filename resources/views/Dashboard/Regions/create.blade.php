<x-dashboard.layout :title="__('dash.add_region')">

    <!--begin::Form-->
    <form method="post" action="{{ route('settings.regions.store') }}" class="form d-flex flex-column flex-lg-row"
        data-kt-redirect="{{ route('settings.regions.index') }}" enctype="multipart/form-data">
        @csrf
        <!--begin::Main column-->
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <x-dashboard.partials.html.select :options="$countries" :name="'country_id'" :title="__('dash.country')" />
                            </div>
                            <!--end::Card header-->
            ...
            <div class="d-flex justify-content-end">
                <!--begin::Button-->
                <a href="{{ route('settings.countries.index') }}" id="kt_ecommerce_add_product_cancel"
