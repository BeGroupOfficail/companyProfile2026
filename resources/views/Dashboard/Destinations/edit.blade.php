<x-dashboard.layout :title="__('dash.edit_destination')">

    <!--begin::Form-->
    <form method="POST" action="{{route('destinations.update',$destination->id)}}" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('destinations.index')}}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <!--begin::Aside column-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    @foreach(config('languages') as $lang => $languageName)
                                        <x-dashboard.partials.html.input
                                            ...
                                            :value="old('name_' . $lang, $destination->getTranslation('name', $lang) ?? '')"
                                            placeholder="{{ __('dash.Enter the name in') }} {{ __($languageName) }}" />
                                    @endforeach

                                    <x-dashboard.partials.html.select
                                        :selectedValue="$destination->country_id"
                                        :options="$countries"
                                        :name="'country_id'"
                                        :id="'country-select'"
                                    ...
                                    <x-dashboard.partials.html.select
                                        :options="$regions"
                                        :name="'region_id'"
                                        :title="__('dash.region')"
                                        :id="'region-select'"
                                        :selectedValue="$destination    ->region_id" />
                                ...
                                @foreach(config('languages') as $lang => $languageName)
                                    <x-dashboard.partials.html.textarea_with_editor
                                        ...
                                        :value="old('desc_' . $lang, $destination->getTranslation('desc', $lang) ?? '')"
                                        placeholder="{{ __('dash.Enter the long desc in') }} {{ __($languageName) }}" />
                                @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex mt-3">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid me-5">
                                                    <input class="form-check-input" type="radio" value="1" name="featured" @checked($destination->featured == 1) >
                                                    <label class="form-check-label" for="home_yes">@lang('dash.yes')</label>
                                                </div>

                                                <div class="form-check form-check-custom form-check-solid">
                                                    <input class="form-check-input" type="radio" value="0" name="featured" @checked($destination->featured == 0)>
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex mt-3">
                                                <!--begin::Radio-->
                                                <div class="form-check form-check-custom form-check-solid me-5">
                                                    <input class="form-check-input" type="radio" value="1" name="home" @checked($destination->home == 1) >
                                                    <label class="form-check-label" for="home_yes">@lang('dash.yes')</label>
                                                </div>

                                                <div class="form-check form-check-custom form-check-solid">
                                                    <input class="form-check-input" type="radio" value="0" name="home" @checked($destination->home == 0)>
                                                    <label class="form-check-label" for="home_no">@lang('dash.no')</label>
                                                </div>
                                                <!--end::Radio-->
                                            </div>
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex mt-3">
                                                <!--begin::Radio-->
                                                <div class="form-check form-check-custom form-check-solid me-5">
                                                    <input class="form-check-input" type="radio" value="1" name="menu" @checked($destination->menu == 1)>
                                                    <label class="form-check-label" for="header_yes">@lang('dash.yes')</label>
                                                </div>

                                                <div class="form-check form-check-custom form-check-solid">
                                                    <input class="form-check-input" type="radio" value="0" name="menu" @checked($destination->menu == 0)>
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    @foreach(config('languages') as $lang => $languageName)
                                        <x-dashboard.partials.html.input
                                            ...
                                            :value="old('slug_' . $lang, $destination->getTranslation('slug', $lang) ?? '')"
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    @foreach(config('languages') as $lang => $languageName)
                                        <x-dashboard.partials.html.input
                                            ...
                                            :value="old('meta_title_' . $lang, $destination->getTranslation('meta_title', $lang) ?? '')"
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    @foreach(config('languages') as $lang => $languageName)
                                        <x-dashboard.partials.html.textarea
                                            ...
                                            :value="old('meta_desc_' . $lang, $destination->getTranslation('meta_desc', $lang) ?? '')"
