<x-dashboard.layout :title="__('dash.add_page')">

    <!--begin::Form-->
    <form method="post" action="{{route('pages.store')}}" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('pages.index')}}" enctype="multipart/form-data">
        @csrf
        <!--begin::Aside column-->
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2">
                <!--begin:::Tab item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#tab1">{{ __('dash.add_page') }}</a>
                </li>
                <!--end:::Tab item-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                @foreach(config('languages') as $lang => $languageName)
                                    <x-dashboard.partials.html.textarea_with_editor
                                        ...
                                        :value="old('name_' . $lang, '')"
                                        placeholder="{{ __('dash.Enter the long text in') }} {{ __($languageName) }}" />
                                @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex mt-3">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid me-5">
                                                    <input class="form-check-input" type="radio" value="1" name="home">
                                                    <label class="form-check-label" for="home_yes">@lang('dash.yes')</label>
                                                </div>

                                                <div class="form-check form-check-custom form-check-solid">
                                                    <input class="form-check-input" type="radio" value="0" name="home" checked>
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex mt-3">
                                                <!--begin::Radio-->
                                                <div class="form-check form-check-custom form-check-solid me-5">
                                                    <input class="form-check-input" type="radio" value="1" name="menu" >
                                                    <label class="form-check-label" for="header_yes">@lang('dash.yes')</label>
                                                </div>

                                                <div class="form-check form-check-custom form-check-solid">
                                                    <input class="form-check-input" type="radio" value="0" name="menu" checked>
